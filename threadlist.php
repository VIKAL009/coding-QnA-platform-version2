...
<?php
 ...
 ?>
    ...
    $showAlert = false;
      ...
      if($method=='POST'){
        ...
        if($showAlert){
            ...
            <strong>success!</strong> Your Question has been added! wait community to respond.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <div class="container my-4">
        <div class="jumbotron">
            <h1 class="display-4">Welcome to <?php echo $catname;?> QnA</h1>
    ...
    echo '<div class="container">
        ...
        <form action="'.$_SERVER["REQUEST_URI"].'" method="post">
            <div class="form-group">
                ...
                <small id="email help" class="form-text text-muted">Keep Your title as short and crisp as
                    possible</small>
            </div>
            <div class="form-group">
